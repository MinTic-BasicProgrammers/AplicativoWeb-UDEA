...
import empresa.apiempresa.util.ItemMenu;
import empresa.apiempresa.util.Login;
import empresa.apiempresa.vista.servicio.UsuarioServicioVista;
...
public class InicioControladorVista {
    ...
    public static List<ItemMenu> generarMenu() {
        ...
        ItemMenu itemMenu = new ItemMenu("Empresa", "/menu/empresa", "fas fa-industry");
        menu.add(itemMenu);
        itemMenu = new ItemMenu("Movimientos", "/menu/movimiento", "fas fa-industry");
        menu.add(itemMenu);
